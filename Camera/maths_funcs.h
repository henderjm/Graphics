...
float getx(const vec3&);
float gety(const vec3&);
float getz(const vec3&);
void setx(const vec3&, float x);
void sety(const vec3& , float y);
void setz(const vec3&, float z); 
void updateVec3(const vec3&, float x, float y, float z);
...
mat4 ortho(GLfloat l, GLfloat r, GLfloat b, GLfloat t, GLfloat n, GLfloat f);
#endif
